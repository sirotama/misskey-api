...
export default [
	...
	{ name: 'users/follow', login: true, limitDuration: hour, limitMax: 100, minInterval: 0.5 * second },
	{ name: 'users/unfollow', login: true, limitDuration: hour, limitMax: 100, minInterval: 0.5 * second },
